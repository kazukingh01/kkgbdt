...
# nohup python exp_datasets.py --iter 1000 --entity xxxxxxx-personal --project exp-gbdt-datasets --jobs 56 --nseed 5 &
# nohup python exp_datasets.py --iter 1000 --entity xxxxxxx-personal --project exp-gbdt-datasets --jobs 56 --nseed 10 --isbest &